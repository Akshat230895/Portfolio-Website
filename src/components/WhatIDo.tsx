        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Developing intelligent systems, analyzing data, and automating workflows to extract meaningful insights.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Google Flow</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Crafting cinematic stories, visual identities, and engaging digital content using modern creative tools.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
